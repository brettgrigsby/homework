...
class RejectTest < Minitest::Test
  ...
  def test_remove_words_ending_in_ing
    ...
    selected = words.reject { |word| word.chars[-3..-1].join == "ing" }
  ...
  def test_remove_numbers
    ...
    almost_not_numbers = elements.reject { |element| element.class == Fixnum }
    not_numbers = almost_not_numbers.reject { |element| element.class == Float }
  ...
  def test_remove_animals_starting_with_vowels
    ...
    remaining = animals.reject { |animal| ["a", "e", "i", "o", "u", "y"].include?(animal.chars.first) }
